...
setup(
    name='hermes-cpt',
    version=_VERSION,
    description='hermes-cpt is a library encapsulating the integration of the HERMES & conso platforms.',
    long_description=_README,
    author='Mark A. Greenslade',
    author_email='momipsl@ipsl.fr',
    url='https://github.com/momipsl/hermes-cpt',
    packages=_PACKAGES,
